...
echo "====Run rgeoda local_moran using NYC and permutation_method=brutal-force"
...
echo "====Run rgeoda local_moran using Chicago_Parcels and permutation_method=brutal-force"

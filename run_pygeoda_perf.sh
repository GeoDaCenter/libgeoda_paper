#!/usr/bin/env bash
echo "Test pyGeoDa local moran with Natregimes using permutation_method=brutal-force"
...
echo "Test pyGeoDa local moran with SDOH using permutation_method=brutal-force"
...
echo "Test pyGeoDa local moran with NYC using permutation_method=brutal-force"
...
echo "Test pyGeoDa local moran with Chicago_Parcels using permutation_method=brutal-force"
python perf_pygeoda.py ./data/Chicago_parcels_points.shp CE01_02 999 brutal-force 1
python perf_pygeoda.py ./data/Chicago_parcels_points.shp CE01_02 999 brutal-force 8
python perf_pygeoda.py ./data/Chicago_parcels_points.shp CE01_02 999 brutal-force 16
python perf_pygeoda.py ./data/Chicago_parcels_points.shp CE01_02 9999 brutal-force 1
python perf_pygeoda.py ./data/Chicago_parcels_points.shp CE01_02 9999 brutal-force 8
python perf_pygeoda.py ./data/Chicago_parcels_points.shp CE01_02 9999 brutal-force 16
python perf_pygeoda.py ./data/Chicago_parcels_points.shp CE01_02 99999 brutal-force 1
python perf_pygeoda.py ./data/Chicago_parcels_points.shp CE01_02 99999 brutal-force 8
python perf_pygeoda.py ./data/Chicago_parcels_points.shp CE01_02 99999 brutal-force 16
